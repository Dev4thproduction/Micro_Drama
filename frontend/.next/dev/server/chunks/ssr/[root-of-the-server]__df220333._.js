...
;
// Backend API URL - defaults to port 5000 where Express runs
...
function AuthProvider({ children }) {
    ...
    const login = async (email, password)=>{
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/login', {
                email,
                password
            });
    ...
    const register = async (email, password, role)=>{
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/register', {
                email,
                password,
                role
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__df220333._.js.map